 ...
 */
define(["require", "exports", "core", "lib/interop/SignalRSockets"], function (require, exports, core, SignalRSockets) {
    "use strict";
    exports.__esModule = true;
    core.createModule("signalr", function (application, options) {
        options = options || {};
        /**
        ...
        return {
            initialize: function (app) {
                app.dataFacade.sockets = new SignalRSockets(options, app);
...
//# sourceMappingURL=module-signalr.js.map