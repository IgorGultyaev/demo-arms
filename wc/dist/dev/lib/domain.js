...
define(["require", "exports", "lib/core.lang", "./domain/support", "./domain/DomainObject", "./domain/UnitOfWork", "./domain/NotLoadedObject", "lib/domain/ComplexValue", "lib/validation", "lib/formatters"], function (require, exports, lang, support, DomainObject, UnitOfWork, NotLoadedObject, ComplexValue, validation, formatters) {
    ...
    var enumMetaMethods = {
        parse: function (v) {
            ...
            if (parser) {
                res = parser.tryParse(this, v);
                if (res.parsedValue !== undefined) {
                    return res.parsedValue;
                }
            }
            res = validation.EnumHelper.tryParse(this.flags, this.members, v);
            if (res.errorMsg) {
        ...
        getMember: function (v) {
            return formatters.EnumHelper.getMember(this.members, v);
        },
        getMembers: function (v) {
            return formatters.EnumHelper.getMembers(this.members, v);
        },
        formatValue: function (v) {
            return formatters.EnumHelper.formatValue(this.flags, this.members, v);
        }
    };
    /**
        ...
        MetadataGenerator.prototype.postprocessEntity = function (entity) {
            ...
            lang.forEach(entity.declared, function (prop) {
                ...
                if (!prop.formatter) {
                    ...
                    if (formatter_1) {
                        prop.formatter = function (value, opts) {
                            if (opts) {
                                opts = lang.extend({}, prop, opts);
                            }
                            return formatter_1(opts || prop, value);
                        };
                    }
                }
    ...
    var ObjectFactory = /** @class */ (function () {
        ...
        ObjectFactory.prototype.createNotAuthorized = function (model, typeName, id) {
            ...
            if (!NotAuthClass) {
                NotAuthClass = /** @class */ (function (_super) {
    ...
    var ModelGenerator = /** @class */ (function () {
        ...
        ModelGenerator.prototype.generate = function (meta) {
            ...
            that.model = /** @lends IDomainModel */ {
                ...
                DomainObject: /** @class */ (function (_super) {
                ...
                UnitOfWork: /** @class */ (function (_super) {
        ...
        ModelGenerator.prototype.genDomainClass = function (entity, BaseClass) {
            ...
            // generate class
            var DomainClass = /** @class */ (function (_super) {
            ...
            // TODO: DomainClass.prototype[Symbol.toStringTag] = function () { return this.meta.name; };
